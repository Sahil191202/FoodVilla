...
import { checkExpiredSubscriptions } from "../jobs/cron.js";
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, {}, "Subscription check completed"));
  }),
);
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    return res
      .status(200)
      .json(new ApiResponse(200, { reservations }, "Reservations fetched"));
  }),
);

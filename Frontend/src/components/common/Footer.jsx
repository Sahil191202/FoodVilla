...
// Custom SVG social icons — lucide doesnt have these!
const InstagramIcon = () => (
    ...
    <footer className="bg-gray-900 text-gray-400 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              ...
              instantly with our AI-powered assistant.
            </p>
            ...
            <div className="flex items-center gap-3 mt-5">
              {SOCIAL_LINKS.map(({ Icon, label }) => (
                <button
                  key={label}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center hover:bg-primary-500 hover:text-white transition-colors"
                >
                  <Icon />
                </button>
              ))}
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs">
            © {new Date().getFullYear()} GoodFoods. All rights reserved.
          </p>
